  ...
  describe("revoke()", () => {
    it("should revoke a client key", async () => {
      ...
      expect(mockFetch.post).toHaveBeenCalledWith(
        "/api/v1/client-keys/key-123/revoke",
        {},
      );
...
describe("WebhooksManager", () => {
  ...
  describe("listDeliveries()", () => {
    it("should list webhook deliveries", async () => {
      ...
      expect(mockFetch.get).toHaveBeenCalledWith(
        "/api/v1/webhooks/webhook-123/deliveries?limit=100",
      );
    ...
    it("should use default limit", async () => {
      ...
      expect(mockFetch.get).toHaveBeenCalledWith(
        "/api/v1/webhooks/webhook-123/deliveries?limit=50",
      );
    });
  });
});
...
describe("InvitationsManager", () => {
  ...
  describe("validate()", () => {
    it("should validate a valid invitation token", async () => {
      ...
      expect(mockFetch.get).toHaveBeenCalledWith(
        "/api/v1/invitations/token-abc123/validate",
      );
  ...
  describe("accept()", () => {
    it("should accept an invitation and create user", async () => {
      ...
      expect(mockFetch.post).toHaveBeenCalledWith(
        "/api/v1/invitations/token-abc123/accept",
        {
          password: "SecurePassword123!",
          name: "New User",
        },
  ...
  describe("revoke()", () => {
    it("should revoke an invitation", async () => {
      ...
      expect(mockFetch.delete).toHaveBeenCalledWith(
        "/api/v1/admin/invitations/token-abc123",
      );
