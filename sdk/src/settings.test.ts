...
describe("SystemSettingsManager", () => {
  ...
  describe("get", () => {
    it("should get a specific setting by key", async () => {
      ...
      expect(mockFetch.get).toHaveBeenCalledWith(
        "/api/v1/admin/system/settings/app.auth.enable_signup",
      );
    ...
    it("should handle not found error", async () => {
      ...
      await expect(manager.get("nonexistent.key")).rejects.toThrow(
        "Setting not found",
      );
    });
  });
  ...
  describe("delete", () => {
    ...
    it("should handle delete errors", async () => {
      ...
      await expect(manager.delete("nonexistent.key")).rejects.toThrow(
        "Setting not found",
      );
    });
  });
...
describe("AppSettingsManager", () => {
  ...
  describe("convenience methods", () => {
    ...
    it("should reject invalid password length", async () => {
      await expect(manager.setPasswordMinLength(7)).rejects.toThrow(
        "Password minimum length must be between 8 and 128",
      );
      await expect(manager.setPasswordMinLength(129)).rejects.toThrow(
        "Password minimum length must be between 8 and 128",
      );
    });
...
describe("AppSettingsManager - Custom Settings", () => {
  ...
  describe("getSetting", () => {
    it("should get setting value without metadata", async () => {
      ...
      expect(mockFetch.get).toHaveBeenCalledWith(
        "/api/v1/admin/settings/custom/features.beta_enabled",
      );
    ...
    it("should handle errors", async () => {
      ...
      await expect(manager.getSetting("nonexistent")).rejects.toThrow(
        "Setting not found",
      );
    });
  });
  ...
  describe("setSetting", () => {
    it("should create new setting if not found", async () => {
      ...
      vi.mocked(mockFetch.put).mockRejectedValue({
        status: 404,
        message: "not found",
      });
      vi.mocked(mockFetch.post).mockResolvedValue(mockSetting);

      const result = await manager.setSetting(
        "billing.tiers",
        { free: 1000, pro: 10000 },
        {
          description: "API quotas",
...
describe("SettingsClient", () => {
  ...
  describe("get", () => {
    it("should get public setting value", async () => {
      ...
      expect(mockFetch.get).toHaveBeenCalledWith(
        "/api/v1/settings/features.beta_enabled",
      );
      expect(result).toEqual({ enabled: true });
    });
    ...
    it("should handle settings with special characters in key", async () => {
      ...
      expect(mockFetch.get).toHaveBeenCalledWith(
        "/api/v1/settings/public.app_version",
      );
...
describe("AppSettingsManager - Additional Methods", () => {
  ...
  describe("deleteSetting", () => {
    it("should delete a custom setting", async () => {
      ...
      expect(mockFetch.delete).toHaveBeenCalledWith(
        "/api/v1/admin/settings/custom/billing.tiers",
      );
    });
  });
});
...
describe("AppSettingsManager - Secret Settings", () => {
  ...
  describe("setSecretSetting", () => {
    it("should update existing secret", async () => {
      ...
      const result = await manager.setSecretSetting(
        "stripe_api_key",
        "sk-xxx",
        {
          description: "Stripe key",
      ...
      expect(mockFetch.put).toHaveBeenCalledWith(
        "/api/v1/admin/settings/custom/secret/stripe_api_key",
        {
          value: "sk-xxx",
          description: "Stripe key",
        },
    ...
    it("should rethrow non-404 errors", async () => {
      ...
      await expect(manager.setSecretSetting("key", "value")).rejects.toEqual({
        status: 500,
        message: "Server error",
      });
    });
  ...
  describe("getUserSecretValue", () => {
    it("should get decrypted user secret value", async () => {
      ...
      expect(mockFetch.get).toHaveBeenCalledWith(
        "/api/v1/admin/settings/user/user-123/secret/api_key/decrypt",
      );
...
describe("AppSettingsManager - setSetting edge cases", () => {
  ...
  it("should update existing setting", async () => {
    ...
    expect(mockFetch.put).toHaveBeenCalledWith(
      "/api/v1/admin/settings/custom/existing.key",
      {
        value: { updated: true },
        value_type: "json",
        description: undefined,
  ...
  it("should wrap primitive values in object", async () => {
    ...
    expect(mockFetch.put).toHaveBeenCalledWith(
      "/api/v1/admin/settings/custom/primitive.key",
      expect.objectContaining({
        value: { value: 42 },
      }),
    );
  ...
  it("should wrap array values in object", async () => {
    ...
    expect(mockFetch.put).toHaveBeenCalledWith(
      "/api/v1/admin/settings/custom/array.key",
      expect.objectContaining({
        value: { value: [1, 2, 3] },
      }),
    );
  ...
  it("should wrap null in object", async () => {
    ...
    expect(mockFetch.put).toHaveBeenCalledWith(
      "/api/v1/admin/settings/custom/null.key",
      expect.objectContaining({
        value: { value: null },
      }),
    );
  ...
  it("should handle non-404 errors on setSetting", async () => {
    ...
    await expect(manager.setSetting("key", { val: 1 })).rejects.toEqual({
      status: 500,
      message: "Server error",
    });
  });
...
describe("EmailTemplateManager", () => {
  ...
  describe("get", () => {
    it("should get template by type", async () => {
      ...
      expect(mockFetch.get).toHaveBeenCalledWith(
        "/api/v1/admin/email/templates/magic_link",
      );
  ...
  describe("reset", () => {
    it("should reset template to default", async () => {
      ...
      expect(mockFetch.post).toHaveBeenCalledWith(
        "/api/v1/admin/email/templates/magic_link/reset",
        {},
      );
      expect(result).toEqual(mockTemplate);
    });
  ...
  describe("test", () => {
    it("should send test email", async () => {
      ...
      expect(mockFetch.post).toHaveBeenCalledWith(
        "/api/v1/admin/email/templates/magic_link/test",
        {
...
describe("SettingsClient - User Settings", () => {
  ...
  describe("getUserSetting", () => {
    it("should get user own setting", async () => {
      ...
      expect(mockFetch.get).toHaveBeenCalledWith(
        "/api/v1/settings/user/own/theme",
      );
      expect(result).toEqual(mockSetting);
    });
  });
  ...
  describe("getSystemSetting", () => {
    it("should get system default setting", async () => {
      ...
      expect(mockFetch.get).toHaveBeenCalledWith(
        "/api/v1/settings/user/system/theme",
      );
      expect(result).toEqual(mockSetting);
    });
  });
  ...
  describe("setSetting", () => {
    it("should set user setting", async () => {
      ...
      const result = await client.setSetting(
        "theme",
        { mode: "dark" },
...
describe("SettingsClient - User Secrets", () => {
  ...
  describe("setSecret", () => {
    it("should update existing secret", async () => {
      ...
      const result = await client.setSecret("openai_key", "sk-xxx", {
        description: "OpenAI API key",
      });

      expect(mockFetch.put).toHaveBeenCalledWith(
        "/api/v1/settings/secret/openai_key",
        {
          value: "sk-xxx",
          description: "OpenAI API key",
        },
    ...
    it("should rethrow non-404 errors", async () => {
      ...
      await expect(client.setSecret("key", "value")).rejects.toEqual({
        status: 500,
        message: "Server error",
      });
    });
