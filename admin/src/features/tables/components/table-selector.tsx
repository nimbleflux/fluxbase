                    ...
                    >
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                            variant={
                              selectedTable === full ? "secondary" : "ghost"
                            }
                            className={cn(
      ...
      <Dialog open={showImportSQL} onOpenChange={setShowImportSQL}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Import a SQL file to create tables and schema. This will execute
              the SQL commands directly on the database.
            </DialogDescription>
          </DialogHeader>
            ...
            <Button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  if (errorCount > 0) {
                    toast.warning(
                      `SQL executed with ${successCount} successful statements and ${errorCount} errors`,
                    );
                  } else {
                    toast.success(
                      `SQL imported successfully (${successCount} statements executed)`,
                    );
                  }
                  ...
                  toast.error(
                    `Failed to import SQL: ${error instanceof Error ? error.message : "Unknown error"}`,
                  );
                } finally {
