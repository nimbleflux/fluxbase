...
[jvm]\
fun [onBroadcast](./)(event: [String](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html), callback: [BroadcastCallback](../../-broadcast-callback/)): [RealtimeChannel](../)
