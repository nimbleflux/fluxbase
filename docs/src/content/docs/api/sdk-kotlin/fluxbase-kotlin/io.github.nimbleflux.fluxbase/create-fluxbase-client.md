...
[jvm]\
fun [createFluxbaseClient](./)(url: [String](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html)? = null, key: [String](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html)? = null, options: [FluxbaseClientOptions](../-fluxbase-client-options/) = FluxbaseClientOptions(), transport: [HttpTransport](../../iogithubnimblefluxfluxbasecore/-http-transport/)? = null): [FluxbaseClient](../-fluxbase-client/)
