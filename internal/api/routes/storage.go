	...
	return &RouteGroup{
		...
		Routes: []Route{
			...
			},
			{
				...
				Auth:        AuthOptional,
				Scopes:      []string{auth.ScopeStorageRead},
				Middlewares: []Middleware{{Name: "RequireScope(storage:read)", Handler: deps.RequireScope(auth.ScopeStorageRead)}},
			},
			{
				Method:      "POST",
				Path:        "/buckets/:bucket",
				...
				Auth:        AuthRequired,
				Scopes:      []string{auth.ScopeStorageWrite},
				Middlewares: []Middleware{{Name: "RequireScope(storage:write)", Handler: deps.RequireScope(auth.ScopeStorageWrite)}},
			},
			{
				Method:      "PUT",
				Path:        "/buckets/:bucket",
			...
			},
			{
				...
				Middlewares: []Middleware{
					...
					{Name: "RequireScope(storage:write)", Handler: deps.RequireScope(auth.ScopeStorageWrite)},
				},
