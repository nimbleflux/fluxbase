...
ALTER TABLE auth.users ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE SET NULL;
...
ALTER TABLE auth.webhooks ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE auth.client_keys ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE functions.edge_functions ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE functions.secrets ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE functions.edge_triggers ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE jobs.functions ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE jobs.queue ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE ai.knowledge_bases ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE ai.documents ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE ai.chatbots ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE ai.conversations ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE ai.user_chatbot_usage ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE ai.user_provider_preferences ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE ai.user_quotas ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE ai.chatbot_knowledge_bases ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE ai.document_permissions ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE ai.knowledge_base_permissions ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE ai.table_export_sync_configs ADD COLUMN IF NOT EXISTS tenant_id UUID REFERENCES platform.tenants(id) ON DELETE CASCADE;
